...
<div class="container">
	...
	<div class="sixteen columns">
		...
		<!-- Page Title -->
		<div id="page-title">
			<h2>1<?php $pf_title = get_post_meta($post->ID, 'centum_portfolio_title', true); if($pf_title) { echo $pf_title;} else { $pp_portfolio_page = ot_get_option('incr_portfolio_page');
...
<div class="container">
	...
	<div id="portfolio-wrapper">
		...
		<div <?php post_class('eight columns portfolio-item'); ?> id="post-<?php the_ID(); ?>" >
			...
			<div class="item-description alt" id="tes43">
