                             ...
                             <!-- 960 Container -->
                                ...
                                <li>
                                    <a href="<?php echo $attachment[0] ?>" rel="image-gallery" title="<?php echo $images->post_title; ?>" >
                                        <img src="<?php echo $thumb[0] ?>" width="<?php echo $thumb[1] ?>px" height="<?php echo $thumb[2] ?>px" alt="<?php echo $images->post_title; ?>" />
                                    </a>
                                </li>
                                <?php endforeach;  ?>
                            </ul>
...
<?php if ($width == 'none' || empty($width)) { ?>
	...
	<div class="four columns reverse">
			<?php if ( is_active_sidebar( 'educationpanel' ) ) : ?>
				<div class="blog-sidebar">
					<?php dynamic_sidebar( 'educationpanel' ); ?>
				</div>
			<?php endif; ?>	
	</div>	
...
<!-- End 960 Container -->
    ...
    <div class="container">
    	<div class="sixteen columns">
    			<!-- Headline -->
    		<div class="headline" style="margin-top: 5px;"><div class="footer-publications-H3" id="test32"><?php _e('Recent Projects', 'purepress'); ?></div> </div>
    	</div>
