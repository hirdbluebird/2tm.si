		...
		<div id="page-title">
			<h2><?php $pf_title = get_post_meta($post->ID, 'centum_portfolio_title', true); if($pf_title) { echo $pf_title;} else { $pp_portfolio_page = ot_get_option('incr_portfolio_page');
				if (function_exists('icl_register_string')) {
                    icl_register_string('Portfolio page title','incr_portfolio_page', $pp_portfolio_page);
                    echo icl_t('Portfolio page title','incr_portfolio_page', $pp_portfolio_page); }
                else {
...
<div class="container">
	...
	<div id="portfolio-wrapper">
		...
		<div <?php post_class('one-third column portfolio-item'); ?> id="post-<?php the_ID(); ?>" >
			...
			<div class="item-description alt" id="tes41">
